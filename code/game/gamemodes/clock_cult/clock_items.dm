...
/obj/item/device/mmi/posibrain/soul_vessel //Soul vessel: An ancient positronic brain with a lawset catered to serving Ratvar.
	...
	req_access = list()
	braintype = "Servant"
	var/begin_activation_message = "<span class='brass'>You activate the cogwheel. It hitches and stalls as it begins spinning.</span>"
	var/success_message = "<span class='brass'>The cogwheel's rotation smooths out as the soul vessel activates.</span>"
	var/fail_message = "<span class='warning'>The cogwheel creaks and grinds to a halt. Maybe you could try again?</span>"
	var/new_role = "Soul Vessel"
	...
	var/new_mob_message = "<span class='brass'>The soul vessel emits a jet of steam before its cogwheel smooths out.</span>"
	var/dead_message = "<span class='deadsay'>Its cogwheel, scratched and dented, lies motionless.</span>"
	var/fluff_names = list("Servant")
	clockwork = TRUE
