	...
	if(istype(user, /mob/living/carbon/human) || istype(user,/mob/living/silicon) )
		...
		switch(screen)
			if(0)
				...
				<BR><A href='?src=[UID()];silence_unit=1'>[silence ? "Unsilence" : "Silence"] unit</A>
				<BR><A href='?src=[UID()];unsilence_unit=1'>Unsilence unit</A>
				<BR><A href='?src=[UID()];refresh=1'>Re-scan User</A>
