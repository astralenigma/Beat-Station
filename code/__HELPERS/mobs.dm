...
/proc/admin_mob_info(mob/M, mob/user = usr)
	...
	to_chat(user, "(<a href='?src=[usr.UID()];priv_msg=[M.UID()]'>PM</a>) (<A HREF='?_src_=holder;adminplayeropts=\ref[M]'>PP</A>) (<A HREF='?_src_=vars;Vars=[M.UID()]'>VV</A>) (<A HREF='?_src_=[UID()];subtlemessage=[M.UID()]'>SM</A>) (<A HREF='?_src_=holder;adminplayerobservefollow=[M.UID()]'>FLW</A>) (<A HREF='?_src_=holder;secretsadmin=check_antagonist'>CA</A>)")
